...
export default defineEventHandler(async (event) => {
  ...
  const body = await readBody<SoftDeleteReplyBody>(event)
  ...
  await logAuditAction(callerId, 'reply_soft_deleted', eventId, { replyId: reply.id })
